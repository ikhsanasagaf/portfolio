...
export const Resume = () => {
  return (
    ...
    >
      ...
      >
        With a background in Computer Science and hands-on experience in web-development and machine learning, I’ve worked on diverse projects. Each project has strengthened my focus
